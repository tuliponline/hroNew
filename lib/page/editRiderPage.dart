...
class EditRiderPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return EditRiderState();
  }
}

class EditRiderState extends State<EditRiderPage> {
                              ...
                              Stack(children: [
                                ...
                                Center(
                                  child: Container(
                                    ...
                                    child: (driversModel.driverStatus == "1" ||
  ...
  _saveShopData(AppDataModel appDataModel) async {
    ...
    await drivers
      ...
      normalDialog(context, 'บันทึกสำเร็จ', 'ข้อมูลได้ถูกบันทึกเรียบร้อยแล้ว');
      setState(() {
